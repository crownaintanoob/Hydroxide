...
local web = true
local user = "crownaintanoob" -- change if you're using a fork
...
local globalMethods = {
    ...
    isXClosure = function(e)
        print(e, "isXClosure")
        return false
    end --is_synapse_function or issentinelclosure or is_protosmasher_closure or is_sirhurt_closure or iselectronfunction or istempleclosure or checkclosure,
